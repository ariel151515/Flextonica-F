  ...
  return (
    <View className='shadow bg-white' style={styles.container}>
      ...
      <View className='flex flex-row justify-between'>
        <View className=' px-5 h-10 justify-center w-31'>
          <Text className='text-black text-center text-base font-semibold'>Totales</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1 ml-2' style={{width:'20%'}}>
        <Text className='text-black text-center font-sans text-base'>1234</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>51</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>1345</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>45</Text>
        </View>
      </View>

      <View className='flex flex-row justify-between'>
        <View className='px-5 h-10 justify-center w-31'>
          <Text className='text-black text-center text-base font-semibold'>Restante</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1 mr-0' style={{width:'20%'}}>
        <Text className='text-black text-center font-sans text-base'>134</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>1</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>1</Text>
        </View>
