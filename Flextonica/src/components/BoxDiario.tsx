  ...
  return (
    <View className='shadow bg-white' style={styles.container}>
      ...
      <View className='flex flex-row justify-between bg-black'>
        <View className='bg-amarillo pt-2 ' style={{width:'24%'}}>
      ...
      <View className='flex flex-row justify-betweene'>
        ...
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>156</Text>
        </View>
        <View className='px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>345</Text>
        </View>
        <View className=' px-5 h-10 justify-center flex-1'>
        <Text className='text-black text-center font-sans text-base'>56</Text>
        </View>
      </View>
